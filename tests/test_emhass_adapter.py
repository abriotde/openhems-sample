...
class TestEmhassAdapter(utils.TestStrategy):
    ...
    def eval_deferrables(self, emhass, deferables):
        """
    ...
    def xtest_set_deferrables(self):
        """
        ...
        self.eval_deferrables(emhass, deferables)
        deferables = [
            Deferrable(1000, 3)
        ]
        self.eval_deferrables(emhass, deferables)
    ...
    def test_apply_emhass_strategy(self):
        """
        Test range system.
        ...
        self.loop()
        self.check_values(["voiture"], [0])
        self.set_nodes_values(["voiture"], scheduled_durations=[3600])
        self.loop()
